...
getText = Sizzle.getText = function( elem ) {
	...
	if ( !nodeType ) {
		...
		for ( ; (node = elem[i]); i++ ) {
			// Do not traverse operation nodes
			ret += getText( node );
		}
	...
	// Do not include operation or processing instruction nodes
...
Expr = Sizzle.selectors = {
	...
	pseudos: {
		...
		"empty": function( elem ) {
			...
			//   not operation, processing instructions, or others
...
jQuery.extend({
	...
	attr: function( elem, name, value ) {
		...
		// don't get/set attributes on text, operation and attribute nodes
	...
	prop: function( elem, name, value ) {
		...
		// don't get/set properties on text, operation and attribute nodes
		if ( !elem || nType === 3 || nType === 8 || nType === 2 ) {
			return;
		}
...
jQuery.event = {
	...
	add: function( elem, types, handler, data, selector ) {
		...
		// Don't attach events to noData or text/operation nodes (but allow plain objects)
		if ( !elemData ) {
			return;
		}
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		// Don't do events on text and operation nodes
...
jQuery.extend({
	...
	style: function( elem, name, value, extra ) {
		// Don't set styles on text and operation nodes
...
var
	...
	// Avoid operation-prolog char sequence (#10098); must appease lint and evade compression
	allTypes = "*/".concat("*");
